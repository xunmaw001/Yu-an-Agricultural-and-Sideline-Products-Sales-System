        ...
        <div class="modal-dialog" style="z-index: 3000">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea id="goodsCommentbackContent" style="width: 400px;height: 300px"></textarea>
                </div>
                <%-- 模态框按钮 --%>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    <button type="button" onclick="submitGoodsCommentback()" class="btn btn-theme">评价</button>
                </div>
            </div>
        </div>
    </div>
...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">农副产品订单管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">农副产品订单列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">农副产品订单列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //订单号
            var goodsOrderUuidNumberCell = document.createElement('td');
            goodsOrderUuidNumberCell.innerHTML = item.goodsOrderUuidNumber;
            row.appendChild(goodsOrderUuidNumberCell);
            ...
            //实付价格
            var goodsOrderTruePriceCell = document.createElement('td');
            goodsOrderTruePriceCell.innerHTML = item.goodsOrderTruePrice;
            row.appendChild(goodsOrderTruePriceCell);
            ...
            //支付类型
            var goodsOrderPaymentTypesCell = document.createElement('td');
            goodsOrderPaymentTypesCell.innerHTML = item.goodsOrderPaymentValue;
            row.appendChild(goodsOrderPaymentTypesCell);
            ...
            if(item.goodsOrderTypes == 2 && window.sessionStorage.getItem('role') == "用户"){
                //退款
            ...
            if(item.goodsOrderTypes == 2 && window.sessionStorage.getItem('role') == "农户"){
                //发货
                var detailListBtn = document.createElement('button');
            ...
            if(item.goodsOrderTypes == 3 && window.sessionStorage.getItem('role') == "用户"){
                //收货
                var detailListBtn = document.createElement('button');
            ...
            if(item.goodsOrderTypes == 4 && window.sessionStorage.getItem('role') == "用户"){
                //评价
                var detailListBtn = document.createElement('button');
    ...
    //查询当前表搜索条件所有列表
        ...
        function refund(id) {
            ...
            http("goodsOrder/refund?id="+id, "GET",{}, (res) => {
                if(res.code == 0){
                    alert('退款成功');
                    getDataList();
                }else{
        ...
        function deliver(id) {
            ...
            http("goodsOrder/deliver?id="+id, "GET",{}, (res) => {
                if(res.code == 0){
                    alert('成功发货');
                    getDataList();
                }else{
        ...
        function receiving(id) {
            ...
            http("goodsOrder/receiving?id="+id, "GET",{}, (res) => {
                if(res.code == 0){
                    alert('成功收货');
                    getDataList();
                }else{
        ...
        function submitGoodsCommentback(){
            var goodsCommentbackContent = $("#goodsCommentbackContent").val();
            var id = $("#id").val();

            http("goodsOrder/commentback?id="+id+"&commentbackText="+goodsCommentbackContent, 'get', {}, function (res) {
                if(res.code==0){
                    alert('评价成功');
                }else{
                    alert(res.msg);
            ...
            $('#goodsCommentbackModal').modal('hide');
        }
