    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑农副产品评价</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">农副产品评价管理</li>
                        <li class="breadcrumb-item active">编辑农副产品评价</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">农副产品评价信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 goodsCommentbackTextDiv">
                                        <label>评价内容</label>
                                        <textarea style="width: 450px"  id="goodsCommentbackText" name="goodsCommentbackText" class="form-control"placeholder="评价内容"></textarea>
                                    </div>
...
<script>
    ...
    var tableName = "goodsCommentback";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("goodsCommentback/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addgoodsCommentback');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                goodsId: "required",
                yonghuId: "required",
                goodsCommentbackText: "required",
                replyText: "required",
            },
            messages: {
                goodsId: "农副产品不能为空",
                yonghuId: "用户不能为空",
                goodsCommentbackText: "评价内容不能为空",
                replyText: "回复内容不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addgoodsCommentback = window.sessionStorage.getItem("addgoodsCommentback");
        if (addgoodsCommentback != null && addgoodsCommentback != "" && addgoodsCommentback != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("goodsCommentback/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#goodsCommentbackText").val(ruleForm.goodsCommentbackText);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            $('#goodsCommentbackText').attr('readonly', 'readonly');
