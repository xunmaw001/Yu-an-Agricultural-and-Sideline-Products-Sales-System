            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">农副产品评价登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>农户</label>
                                            <input style="width: 450px" id="shangjiaId" name="shangjiaId" class="form-control"
                                                   v-model="ruleForm.shangjiaId" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="goodsKucunNumber" name="goodsKucunNumber" class="form-control"
                                                   v-model="ruleForm.goodsKucunNumber" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="cuxiaoValue" name="cuxiaoValue" class="form-control"
                                               v-model="ruleForm.cuxiaoValue" readonly>
                                    </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="goodsOldMoney" name="goodsOldMoney" class="form-control"
                                                   v-model="ruleForm.goodsOldMoney" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="goodsNewMoney" name="goodsNewMoney" class="form-control"
                                                   v-model="ruleForm.goodsNewMoney" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="goodsClicknum" name="goodsClicknum" class="form-control"
                                                   v-model="ruleForm.goodsClicknum" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>评价内容</label>
                                        <input style="width: 450px" id="goodsCommentbackText" name="goodsCommentbackText" class="form-control"
                                               v-model="ruleForm.goodsCommentbackText" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "goodsCommentback/info/" + id,
