        ...
        <li v-for="(item,index) in centerMenu" v-bind:key="index" :class="index==0?'bbbb':''">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="goodsName" id="goodsName" lay-verify="required" placeholder="农副产品名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="goodsKucunNumber" id="goodsKucunNumber"  lay-verify="required|integer"   placeholder="农副产品库存" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="cuxiaoTypes" id="cuxiaoTypes">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    <label class="layui-form-label">农副产品原价</label>
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="goodsOldMoney" id="goodsOldMoney"  placeholder="农副产品原价" autocomplete="off" class="layui-input" style="width: 500px">
