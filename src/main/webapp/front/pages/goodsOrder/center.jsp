    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="goodsOrderUuidNumber" id="goodsOrderUuidNumber" lay-verify="required" placeholder="订单号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="buyNumber" id="buyNumber"  lay-verify="required|integer"   placeholder="购买的数量" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="goodsOrderTruePrice" id="goodsOrderTruePrice"  lay-verify="required|double"   placeholder="实付价格" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="goodsOrderTypes" id="goodsOrderTypes">
                                    <option v-for="item in goodsOrderTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="goodsOrderPaymentTypes" id="goodsOrderPaymentTypes">
                                    <option v-for="item in goodsOrderPaymentTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`goodsOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
