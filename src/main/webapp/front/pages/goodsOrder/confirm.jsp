        ...
        <div class="section-con">
            ...
            <div class="orderBox">
                <div class="orderC-table">
                        ...
                        <tr v-for="(item,index) in dataList" v-bind:key="index">
                            <td class="text-left">
                                <div class="order-gw clearfix">
                                    <div class="order-img"><img :src="item.goodsPhoto"/></div>
                                    <div class="order-sum">
                                        <h2>{{item.goodsName}}</h2>
                                    </div>
                                </div>
                            </td>
                            <td>{{item.goodsNewMoney}} RMB</td>
                            <td>
                                {{item.buyNumber}}
                            </td>
                            <td >
                                <span class="priceD">￥{{item.goodsNewMoney*item.buyNumber}}</span>
                            </td>
                        </tr>
                        </tbody>
                    </table>

                    <div class="orderC-total" v-if="this.goodsOrderPaymentTypes == 1">
                        <div class="order-t">
                            <dl class="clearfix">
                    ...
                    <div class="orderC-total" v-if="this.goodsOrderPaymentTypes == 2">
                        <div class="order-t">
                            <dl class="clearfix">
                                <dd class="dl_ddL">总&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价：</dd>
