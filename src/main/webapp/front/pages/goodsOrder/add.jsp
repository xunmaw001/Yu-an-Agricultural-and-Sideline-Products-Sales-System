        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="goods.goodsKucunNumber" type="text" readonly="readonly" name="goodsKucunNumber" id="goodsKucunNumber"   placeholder="农副产品库存" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item" pane>
                <label class="layui-form-label">是否促销：</label>
                <div class="layui-input-inline">
                    <input v-model="goods.cuxiaoValue" type="text" readonly="readonly" placeholder="是否促销" autocomplete="off" class="layui-input">
                </div>
            </div>
