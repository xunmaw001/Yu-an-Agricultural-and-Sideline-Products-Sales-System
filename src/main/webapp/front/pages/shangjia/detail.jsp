        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="blog-details-wrapper">
                    <div><img :src="detail.shangjiaPhoto" alt="image" style="width: 80%;height: auto" ></div>
                    <div class="blog-details-header">
                        <h3 class="blog-details-title">{{title}}</h3>
                        <ul class="post-meta">
                            <li v-if="detail.shangjiaPhone">联系方式：
                                {{detail.shangjiaPhone}}
                            </li>
                            <li v-if="detail.shangjiaEmail">邮箱：
                                {{detail.shangjiaEmail}}
                            </li>
                            <li v-if="detail.shangjiaYesnoTypes">审核状态：
                                {{detail.shangjiaYesnoValue}}
                            </li>
                            <li v-if="detail.newMoney">现有余额：
                                {{detail.newMoney}}
                            </li>
                        </ul>
                    ...
                    <div class="blog-details-content"v-html="myFilters(detail.shangjiaContent)">
                    </div>
                </div>
            <div class="col-lg-4" v-if="shangjiaRecommendList">
                <div class="sidebar">
                    ...
                    <div class="widget">
                        ...
                        <ul class="small-post-list">
                            <li class="small-post-single" v-for="(item,index) in shangjiaRecommendList" v-bind:key="index" @click="jump('../shangjia/detail.jsp?id='+item.id)">
                                <div class="thumb"><img width="65px" :src="item.shangjiaPhoto"  alt="image"></div>
                                <div class="content">
                                    <a class="main_color" class="date">{{item.shangjiaName}}</a>
                                    <h6 v-if="item.shangjiaNewMoney" class="post-title"><a style="color: red">{{item.shangjiaNewMoney}}</a>RMB</h6>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        http.request(`shangjia/list`, 'get', {
            ...
            shangjiaDelete: 1,
                ...
                shangjiaYesnoTypes: vue.detail.shangjiaYesnoTypes,
