                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="shangjiaName" id="shangjiaName" placeholder="农户名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                    ...
                    <section style="margin: 10px">
                        <div class="row">
                            <div v-for="(item,index) in dataList" class="col-md-3">
                                <div class="gallery-demo" @click="jumpCheck('../shangjia/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <img :src="item.shangjiaPhoto?item.shangjiaPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                    <h4 class="p-mask">{{item.shangjiaName}}
                                        <span v-if="item.shangjiaNewMoney"> - ￥{{item.shangjiaNewMoney}}</span>
                                        <span v-else> - {{item.shangjiaValue}}</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function shangjiaYesnoTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=shangjia_yesno_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.shangjiaYesnoTypesList = res.data.list;
                }
            });
        }
