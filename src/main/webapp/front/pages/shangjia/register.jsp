            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">农户名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="shangjiaName" id="shangjiaName"  placeholder="农户名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
  ...
  <!-- 邮箱 -->
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">审核状态:</span>
                        <div class="layui-input-inline">
                            <select name="shangjiaYesnoTypes" id="shangjiaYesnoTypes" lay-filter="shangjiaYesnoTypes" style="width: 600px;">
                                <option v-for="item in shangjiaYesnoTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                            </select>
                        </div>
                    </div>
                </div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'form', 'http', 'jquery', 'laydate'], function() {
      ...
      function shangjiaYesnoTypesSelect() {
        //填充下拉框选项
          http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=shangjia_yesno_types", "GET", {}, (res) => {
              if(res.code == 0){
