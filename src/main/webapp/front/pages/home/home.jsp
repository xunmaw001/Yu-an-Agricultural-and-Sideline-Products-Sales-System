                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="portfolio" id="gallery">
                        <div class="portfolio-agile">
                            <div class="main">
                                <div v-for="(item,index) in newsList" v-bind:key="index" class="view view-seventh" style="width: 23%;height: 300px">
                                    <a @click="jumpCheck('../news/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="b-link-stripe b-animate-go thickbox">
                                        <img :src="item.newsPhoto?item.newsPhoto.split(',')[0]:''"  style="height: 350px;width:100%;" />
                                        <div class="mask">
                                            <h4>
                                                <b>{{item.newsName}}</b>
                                                <br>
                                                <b v-if="item.newsNewMoney">{{item.newsNewMoney}} RMB</b>
                                                <b v-else>{{item.newsValue}}</b>
                                            </h4>
                                        </div>
                                    </a>
                                </div>
            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="portfolio" id="gallery">
                        <div class="portfolio-agile">
                            <div class="main">
                                <div v-for="(item,index) in goodsList" v-bind:key="index" class="view view-seventh" style="width: 23%;height: 300px">
                                    <a @click="jumpCheck('../goods/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="b-link-stripe b-animate-go thickbox">
                                        <img :src="item.goodsPhoto?item.goodsPhoto.split(',')[0]:''"  style="height: 350px;width:100%;" />
                                        <div class="mask">
                                            <h4>
                                                <b>{{item.goodsName}}</b>
                                                <br>
                                                <b v-if="item.goodsNewMoney">{{item.goodsNewMoney}} RMB</b>
                                                <b v-else>{{item.goodsValue}}</b>
                                            </h4>
                                        </div>
                                    </a>
                                </div>
