...
public class GoodsEntity<T> implements Serializable {
     ...
     * 是否促销
     */
    @TableField(value = "cuxiao_types")

    private Integer cuxiaoTypes;
    ...
    public void setCuxiaoTypes(Integer cuxiaoTypes) {
        this.cuxiaoTypes = cuxiaoTypes;
    }
    /**
	 * 设置：农副产品原价
	 */
