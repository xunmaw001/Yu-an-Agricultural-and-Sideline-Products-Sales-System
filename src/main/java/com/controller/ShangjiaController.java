...
//                            shangjiaEntity.setShangjiaName(data.get(0));                    //农户名称 要改的
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        if(shangjia==null || !shangjia.getPassword().equals(password))
            ...
            return R.error("账户未审核或未通过审核");
        //  // 获取监听器中的字典表
        // ServletContext servletContext = ContextLoader.getCurrentWebApplicationContext().getServletContext();
        // Map<String, Map<Integer, String>> dictionaryMap= (Map<String, Map<Integer, String>>) servletContext.getAttribute("dictionaryMap");
        // Map<Integer, String> role_types = dictionaryMap.get("role_types");
        // role_types.get(.getRoleTypes());
        String token = tokenService.generateToken(shangjia.getId(),username, "shangjia", "农户");
        R r = R.ok();
        r.put("token", token);
        r.put("role","农户");
