...
public class CommonController{
	 ...
	 */
	@IgnoreAuth
	@RequestMapping("/group/groupMonth")
	public R group1(String riqi, HttpServletRequest request) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("shangjiaId",request.getSession().getAttribute("userId"));
		params.put("riqi",riqi);
	 ...
	 * 分组统计
	 */
	@RequestMapping("/group/groupYear")
	@IgnoreAuth
	public R group(String riqi, HttpServletRequest request) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("shangjiaId",request.getSession().getAttribute("userId"));
		params.put("riqi",riqi);
